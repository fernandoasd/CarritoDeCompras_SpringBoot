...
//    Transsactional sirve para no implementar JPQL
    @Transactional
    public void updateProduct(Long productId, String nombre, String categoria, String subCategoria, String descripcion, String precio, String foto, String tamanio, String tipo) {
    Product product = productRepository.findById(productId).orElseThrow(() -> new IllegalStateException(
        ...
        if (categoria != null &&
                categoria.length() > 0 &&
                !Objects.equals(product.getCategoria(), categoria)){
